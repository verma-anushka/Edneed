...
class PendingInvitationHoc extends Component {
    ...
    componentDidMount() {
        ...
        this.props.findInvitation(this.props.invitationType, "5eaba792c564fd324b42c03b");
    }

    LoadMore = skip => {
        // this.props.findInvitationMore(this.props.invitationType, this.props.user._id, skip);
        this.props.findInvitationMore(this.props.invitationType, "5eaba792c564fd324b42c03b", skip);
    }

    AcceptInvitation = id => {
        this.props.AcceptInvitation(this.props.invitationType, id);
    }

    RejectInvitation = id => {
        this.props.RejectInvitation(this.props.invitationType, id);
    }
